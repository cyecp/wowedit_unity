...
namespace CASCLib
{
    ...
    public ref struct PathBuffer
    {
        ...
        public static PathBuffer CreatePathBuffer()
        {
            var pb = new PathBuffer();
            pb.Data = new byte[512];
            return pb;
        }
    ...
    public class TVFSRootHandler : RootHandlerBase
    {
        ...
        public TVFSRootHandler(BackgroundWorkerEx worker, CASCHandler casc)
        {
            ...
            using (var reader = new BinaryReader(rootFile))
            {
                ...
                PathBuffer PathBuffer = PathBuffer.CreatePathBuffer();
        ...
        private int CaptureVfsSpanEntry(ref TVFS_DIRECTORY_HEADER dirHeader, ReadOnlySpan<byte> vfsSpanEntry, ref VfsRootEntry vfsRootEntry)
        {
        ...
        private bool IsVfsSubDirectory(CASCHandler casc, out TVFS_DIRECTORY_HEADER subHeader, in MD5Hash eKey)
        {
